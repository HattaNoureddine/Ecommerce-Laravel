                ...
                <div class="table-responsive scrollbar">
                  <table class="table table-bordered table-striped fs--1 mb-0">
                    <thead class="bg-200 text-900">
                      <tr>
                        <th class="sort" data-sort="name">Commande</th>
                        <th class="sort" data-sort="email">Totale</th>
                        <th class="sort" data-sort="email">Etat</th>
                        <th class="sort" data-sort="email">Client Nom</th>
                        <th class="sort" data-sort="email">Client Email</th>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            <td class="name">N{{ $index+1 }}</td>
                            <td class="age">{{ $commande->getTotal() }} MAD</td>
                            <td class="email">
