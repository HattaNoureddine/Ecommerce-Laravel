...
<form action="/louer/product/store" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label class="form-label" for="exampleFormControlInput1">description</label>
         <input class="form-control" id="exampleFormControlInput1" type="text" name="description" placeholder="description......">
    </div>
    ...
    <div class="mb-3">
        <label class="form-label" for="exampleFormControlInput1">qte</label>
         <input class="form-control" id="exampleFormControlInput1" type="text" name="qte" placeholder="qte......">
    </div>
