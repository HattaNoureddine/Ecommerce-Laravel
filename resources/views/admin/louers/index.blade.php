...
<a href="/louer/product/create" class="btn btn-primary mt-8">Ajouter</a>


<div class="mt-5" id="tableExample2" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;age&quot;],&quot;page&quot;:5,&quot;pagination&quot;:true}">
      ...
      <table class="table table-bordered table-striped fs--1 mb-0">
        <thead class="bg-200 text-900">
          <tr>
            ...
            <th class="sort" data-sort="age">price</th>
       ...
       <tr>
        ...
        <td class="age">{{ $item->price }}</td>
        <td class="age">{{ $item->qte }}</td>
        <td class="age"><img width="100px" src="{{ asset('uploads') }}/{{ $item->photo }}" alt=""></td>
        <td class="age">
            <a href="/louer/product/edit/{{ $item->id }}" class="btn btn-primary ">edit</a>
            <a href="/louer/product/detele/{{ $item->id }}" class="btn btn-danger mt-1">delete</a>
        </td>
       </tr>
       @endforeach
        </tbody>
