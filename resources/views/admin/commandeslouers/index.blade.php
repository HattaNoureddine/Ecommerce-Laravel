                  ...
                  <table class="table table-bordered table-striped fs--1 mb-0">
                    <thead class="bg-200 text-900">
                      <tr>
                        ...
                        <th class="sort" data-sort="email">prenom</th>
                        <th class="sort" data-sort="email">tel</th>
                        <th class="sort" data-sort="email">adresse </th>
                        <th class="sort" data-sort="email">date de debut</th>
                        <th class="sort" data-sort="email">date de fin</th>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            <td class="age"><img width="100px" src="{{ asset('uploads') }}/{{ $commande->image_cin }}" alt="" srcset=""></td>
                         
                        <td>{{ $commande->nom }}</td>
                        <td>{{ $commande->prenom }}</td>
                          
                    <td class="age">{{ $commande->tel }}</td>
                    <td class="age">{{ $commande->addresse }}</td>
                    <td class="age">{{ $commande->date_debut }}</td>
                    <td class="age">{{ $commande->date_fin }}</td>
                    <td>
                        <a href="/louer/product/detele/{{ $commande->id }}" class="btn btn-danger">delete</a>
                    </td>
                        </tr>
                        @endforeach
                    </tbody>
