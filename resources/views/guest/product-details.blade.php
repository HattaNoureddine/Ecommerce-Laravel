...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            <h3 class="font-weight-semi-bold mb-4">{{ $product->price }}MAD</h3>
            <p class="mb-4">{{ $product->description }}.</p>
        
            <form action="/client/order/store" method="POST">
                @csrf
                <input type="hidden" class="form-control bg-secondary text-center" value="{{ $product->id }}" name="idproduct" >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="media mb-4">
                                ...
                                <div class="media-body">
                                    <h6>{{ $review->user->name }}<small> - <i>{{ $review->user->created_at }}</i></small></h6>
                        ...
                        <div class="col-md-6">
                            ...
                            <form action="/client/review/store" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="rate" type="number" max="5" min="1"  class="form-control" >
                                </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="card product-item border-0 mb-4">
                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                    <img class="img-fluid w-100" src="{{ asset('uploads') }}/{{ $item->photo }}" alt="">
                </div>
                ...
                <div class="card-footer d-flex justify-content-between bg-light border">
                    <a href="/product/details/{{ $item->id }}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
